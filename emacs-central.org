...
#+BEGIN_SRC emacs-lisp :mkdirp yes :tangle base/personal-info.el
;;; personal-info.el -*- lexical-binding: t; -*-
...
#+BEGIN_SRC emacs-lisp :mkdirp yes :tangle base/modeline-conf.el
  ;;; modeline-conf.el -*- lexical-binding: t; -*-
